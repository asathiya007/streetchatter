...
class StreetChatter:
    def __init__(self, character_name=None):
        ...
        self.embedding_model = NVIDIAEmbeddings(model=EMBEDDING_MODEL_NAME)
        ...
        embed_dims = len(
            self.embedding_model.embed_query('lorem ipsum dolor'))
        ...
        self.doc_store.merge_from(
            FAISS.from_documents(context_docs, self.embedding_model))
